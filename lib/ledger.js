 ...
 */
export const getAddress = ({ path = "44'/1729'/0'/0'", displayConfirm = true, curve = 0x00, } = {}) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
export const signOperation = ({ path = "44'/1729'/0'/0'", rawTxHex, curve = 0x00, magicBytes = magicBytesMap.generic, }) => __awaiter(void 0, void 0, void 0, function* () {
    const transport = yield LedgerTransport.create();
    const tezosLedger = new LedgerApp(transport);
    let signature;
    try {
        const magicBytesHex = `00${magicBytes}`.slice(-2);
        ({ signature } = yield tezosLedger.signOperation(path, `${magicBytesHex}${rawTxHex}`, curve));
    }
    catch (e) {
        transport.close();
        return e;
