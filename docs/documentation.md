...
*   `interval` **[number][4]** The interval to check new blocks (in seconds) (optional, default `10`)
*   `timeout` **[number][4]** The time before the operation times out (in seconds) (optional, default `180`)
...
*   `operation` **([Object][1] | [Array][5])** The operation object or list of objects
*   `source` **[string][2]?** The source of the operation

Returns **[Promise][3]** The operations with populated limits
...
Returns **[Promise][3]** The head block metadata
...
Returns **[Promise][3]** Pending operations
...
Returns **[Promise][3]** An initialized contract class
...
*   `paramObject` **[Object][1]** The parameters for the operation
    ...
    *   `paramObject.balance` **[number][4]** The amount in tez to transfer for the initial balance
    ...
    *   `paramObject.fee` **[number][4]** The fee to set for the transaction (optional, default `1420`)
    *   `paramObject.gasLimit` **[number][4]** The gas limit to set for the transaction (optional, default `10600`)
    *   `paramObject.storageLimit` **[number][4]** The storage limit to set for the transaction (optional, default `257`)
...
*   `paramObject` **[Object][1]** The parameters for the operation
    ...
    *   `paramObject.operation` **([Object][1] | [Array][5])** The operation to include in the transaction
    *   `paramObject.source` **[string][2]?** The source address of the operation
    *   `paramObject.simulated` **[boolean][7]?** Whether the operation is being prepared for a simulation
...
*   `paramObject` **[Object][1]** The parameters for the operation
    ...
    *   `paramObject.fee` **[number][4]** The fee to set for the transaction (optional, default `1420`)
    *   `paramObject.gasLimit` **[number][4]** The gas limit to set for the transaction (optional, default `10600`)
    *   `paramObject.storageLimit` **[number][4]** The storage limit to set for the transaction (optional, default `0`)
...
*   `amount` **[number][4]** Amount in tez to send
*   `input` **([string][2] | Micheline)** Input to run though code
*   `storage` **([string][2] | Micheline)** State of storage
*   `trace` **[boolean][7]** Whether to trace (optional, default `false`)
...
*   `paramObject` **[Object][1]** The parameters for the operation
    ...
    *   `paramObject.operation` **([Object][1] | [Array][5])** The operation to include in the transaction
    *   `paramObject.source` **[string][2]?** The source address of the operation
    *   `paramObject.skipSignature` **[boolean][7]** Use default signature for specific transactions (optional, default `false`)
    *   `paramObject.skipPrevalidation` **[boolean][7]** Skip prevalidation before injecting operation (optional, default `false`)
...
*   `transferParams` **([Object][1] | [Array][5])** The parameters for the operation

    *   `transferParams.to` **[string][2]** The address of the recipient
    *   `transferParams.amount` **[number][4]** The amount in tez to transfer for the initial balance
    *   `transferParams.source` **[string][2]?** The source address of the transfer
    *   `transferParams.fee` **[number][4]** The fee to set for the transaction (optional, default `1420`)
    *   `transferParams.parameters` **[string][2]?** The parameter for the transaction
    *   `transferParams.gasLimit` **[number][4]** The gas limit to set for the transaction (optional, default `10600`)
    *   `transferParams.storageLimit` **[number][4]** The storage limit to set for the transaction (optional, default `300`)
...
*   `gas` **[number][4]** The the gas limit
