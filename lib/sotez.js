    ...
    constructor(provider = 'http://127.0.0.1:8732', chain = 'main', options = {}) {
        ...
        */
        ...
        this.account = ({ balance, spendable, delegatable, delegate, fee = this.defaultFee, gasLimit = 10600, storageLimit = 257, }) => __awaiter(this, void 0, void 0, function* () {
            ...
            const operation = [Object.assign({ kind: 'origination', balance: utility.mutez(balance), fee, gas_limit: gasLimit, storage_limit: storageLimit, manager_pubkey: this.key.publicKeyHash() }, params)];
         ...
         */
        this.getDelegate = (address) => (this.query(`/chains/${this.chain}/blocks/head/context/contracts/${address}/delegate`)
            .then((delegate) => {
            if (delegate) {
                return delegate;
            }
        ...
        this.prepareOperation = ({ operation, source }) => {
            ...
            return Promise.all(promises).then(([header, metadata, manager, headCounter]) => __awaiter(this, void 0, void 0, function* () {
                ...
                return Object.assign(Object.assign({}, fullOp), { counter });
            }));
        };
        /**
         ...
         */
        this.simulateOperation = ({ operation, source }) => (this.prepareOperation({ operation, source }).then(fullOp => (this.query(`/chains/${this.chain}/blocks/head/helpers/scripts/run_operation`, fullOp.opOb))));
        /**
        ...
        this.sendOperation = ({ operation, source, skipPrevalidation = false, skipSignature = false }) => __awaiter(this, void 0, void 0, function* () {
            const fullOp = yield this.prepareOperation({ operation, source });
            if (skipSignature) {
         ...
         * @returns {Promise} Object containing the injected operation hash
         */
        this.silentInject = (sopbytes) => (this.query('/injection/operation', sopbytes).then(hash => ({ hash })));
        /**
